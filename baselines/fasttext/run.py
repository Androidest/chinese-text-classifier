...
model = fasttext.train_supervised(
    ...
    autotuneValidationFile=dev_preprocessed_path, # 自动调参验证集
    autotuneDuration=600, # 自动调参时间
    wordNgrams=2, 
...
print('dev集：', model.test(dev_preprocessed_path))
print('test集：', model.test(test_preprocessed_path))